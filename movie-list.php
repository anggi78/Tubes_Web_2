      ...
      <div class="table-responsive">
        ...
        ?>
            <tr>
              ...
              <td>
                  <a class="bi bi-pencil-fill text-white" href="#" onclick="confirmEdit('<?php echo $data['name']?>')"></a>
              </td>
              <td>
                  <a class="bi bi-x-square-fill text-white" href="#" onclick="confirmDelete('<?php echo $data['name']?>')"></a>
              </td>

            <script>
              function confirmDelete(name) {
              if(confirm("Anda yakin ingin menghapus film "+name+"?")) {
              window.location.href = "delete.php?kode="+name;
              }
            }
            </script>
            ...
            <script>
              function confirmEdit(name){
                if(confirm("Anda yakin ingin mengedit film "+name+"?")) {
              window.location.href = "edit.php?kode="+name;
              }
           }
            </script>
